"""
Documentation Generator for EMS Application

This script generates comprehensive documentation of the EMS application
including functionality details, class descriptions, and screenshots.
"""
import os
import inspect
import importlib
...
def get_module_details(module):
    """Extract class and function details from a module"""
...
def generate_html_documentation():
    ...
    modules = [models, auth, employee, feedback, utils]
    modules_data = [get_module_details(module) for module in modules]
    ...
    <body>
        ...
        <div class="toc">
            ...
            <ul>
                ...
                <li><a href="#class-details">Class Details</a>
                    <ul>
    """
    
    # Add module links to TOC
    for module_data in modules_data:
        html += f'<li><a href="#{module_data["name"]}">{module_data["name"]}</a></li>\n'
